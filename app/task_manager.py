...
class TaskManager:
    ...
    def _update_task_attribute(self, identifier: Task | str | int, attribute: str, value):
        try:
    ...
    def set_task_due_date(self, identifier: Task | str | int, new_due_date: str | datetime):
    ...
    def get_task_by_id(self, task_id: int) -> Optional[Task]:
        try:
            ...
            print("task not found by task id")
            return None
    ...
    def get_task_by_index(self, task_index: int) -> Optional[Task]:
        try:
            ...
            print("task not found by task index")
            return None
